...
<body>
    ...
    <section>
        <div style="text-align: center">
            ...
            <p style="font-size: 10px; text-align: left">En la fecha hago entrega del equipo, tomando conocimiento que
                esta casa de informática, <b>no se responsabiliza</b> por la información que se halle en el
                mismo, siendo responsabilidad del usuario realizar las copias de seguridad que correspondan así como
                tampoco de su hardware.</p>
        </div>
        ...
        <table>
            <tr>
                ...
                <th class="text-left" width="100">Subunidad de destino</th>
                <th class="text-left" width="95">Telefono</th>
                <th class="text-left" width="100">Ip del equipo</th>
            </tr>
            <tr>
                ...
                <td width="100">{{ $servicio->aequipo->ip }}</td>
            </tr>
        </table>
        <table>
            <tr>
            ...
            <tr>
                <td align="justify" width="500">{{ $servicio->accesorios }}</td>
            </tr>
        </table>
        <table>
            <tr>
    ...
    <section>
        ...
        <table>
            ...
            <tr>
                ...
                <td align="left" width="95">{{ $servicio->aequipo->telefono }}</td>
                <td align="left" width="100">{{ $servicio->aequipo->ip }}</td>
            </tr>
        </table>
        <table>
            <tr>
    ...
    <section>
        ...
        <div style="text-align: center">
            <p><img src="images/sellopdi_tecnico.png"></p>
        </div>
        <div style="text-align: center; font: Garamond; font-size: 10px">
            Tel: 0342 4505100 internos 6228/6229/6236/6235. Cel: 0342 155 900004. E-mail: divinformatica@santafe.gov.ar
        </div>
